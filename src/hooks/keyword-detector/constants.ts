...
1. **Fire parallel background agents** for comprehensive context:
   \`\`\`
   delegate_task(subagent_type="explore", prompt="Find existing patterns for [topic] in codebase", run_in_background=true, load_skills=[])
   delegate_task(subagent_type="explore", prompt="Find test infrastructure and conventions", run_in_background=true, load_skills=[])
   delegate_task(subagent_type="librarian", prompt="Find official docs and best practices for [technology]", run_in_background=true, load_skills=[])
   \`\`\`
